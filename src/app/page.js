            ...
            {activeTab === 'signup' && (
              <>
                ...
                <div className="relative flex justify-center lg:justify-end">
                  <div className="relative transform rotate-6 hover:rotate-3 transition-transform duration-700 ease-out">
                    <div className="absolute inset-0 bg-gradient-to-tr from-gray-900/40 to-gray-600/40 rounded-[3rem] blur-2xl transform translate-y-4"></div>
                    <div className="relative bg-gray-900 rounded-[3rem] p-3 shadow-2xl border border-gray-800">
                      ...
                      <div className="w-[80px] h-[400px] md:w-[230px] md:h-[480px] rounded-[2.5rem] overflow-hidden bg-white border-[0.5px] border-gray-400">
                        <Image
                          src="/login.png"
                          alt="Login Screen"
                          width={260}
            ...
            {activeTab === 'search' && (
              <>
                <div className="space-y-5 order-2 lg:order-1">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">For Renters:</h2>
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <p className="text-gray-700 leading-relaxed text-sm md:text-base pt-1">
                            Simply enter your destination to explore nearby available vehicles.
                          </p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="flex-shrink-0 w-9 h-9 bg-gray-900 rounded-lg flex items-center justify-center mt-0.5">
                          ...
                          <p className="text-gray-700 leading-relaxed text-sm md:text-base pt-1">
                            View real photos, pricing, distance, and vehicle details.
                          </p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="flex-shrink-0 w-9 h-9 bg-gray-900 rounded-lg flex items-center justify-center mt-0.5">
                          ...
                          <p className="text-gray-700 leading-relaxed text-sm md:text-base pt-1">
                            Filter by vehicle type, price range, or location to find the perfect ride instantly.
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div className="pt-3">
                    <Link
                      href="/book/bike"
                      className="inline-block px-6 py-2.5 bg-gray-900 text-white rounded-lg font-bold text-sm md:text-base hover:bg-gray-800 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
                    >
                      Start Searching
                    </Link>
                  </div>
                ...
                <div className="relative flex justify-center lg:justify-start order-1 lg:order-2">
                  <div className="relative transform rotate-6 hover:rotate-4 transition-transform duration-500">
                    <div className="absolute inset-0 bg-gradient-to-br from-gray-900 to-gray-700 rounded-[3rem] blur-xl opacity-20"></div>
                    <div className="relative bg-gray-900 rounded-[3rem] p-1.5 shadow-2xl">
                      {/* iPhone notch */}
                      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-24 h-6 bg-gray-900 rounded-b-2xl z-10"></div>
                      <div className="w-[220px] h-[400px] md:w-[230px] md:h-[480px] rounded-[2.5rem] overflow-hidden bg-white border-2 border-gray-800">
                        <Image
                          src="/Home_screen.png"
                          alt="Home Screen"
                          width={260}
            ...
            {activeTab === 'list' && (
              <>
                <div className="space-y-5">
                  ...
                  <div className="space-y-4">
                    <div>
                      <h2 className="text-xl md:text-2xl font-bold text-gray-900 mb-3">For Vehicle Owners:</h2>
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          <div className="flex-shrink-0 w-9 h-9 bg-gray-900 rounded-lg flex items-center justify-center mt-0.5">
                            <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          ...
                          <p className="text-gray-700 leading-relaxed text-sm md:text-base pt-1">
                            Add your bike or car with clear details—photos, availability, location, and pricing.
                          </p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="flex-shrink-0 w-9 h-9 bg-gray-900 rounded-lg flex items-center justify-center mt-0.5">
                          ...
                          <p className="text-gray-700 leading-relaxed text-sm md:text-base pt-1">
                            You can set your own rules (timings, access instructions, or restrictions), and update them anytime.
                          </p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="flex-shrink-0 w-9 h-9 bg-gray-900 rounded-lg flex items-center justify-center mt-0.5">
                          ...
                          <p className="text-gray-700 leading-relaxed text-sm md:text-base pt-1">
                            Your listing becomes visible to thousands of renters searching for reliable vehicles in your area.
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="relative flex justify-center lg:justify-end">
                  <div className="relative transform rotate-6 hover:rotate-4 transition-transform duration-500">
                    ...
                    <div className="relative bg-gray-900 rounded-[3rem] p-1.5 shadow-2xl">
                      {/* iPhone notch */}
                      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-24 h-6 bg-gray-900 rounded-b-2xl z-10"></div>
                      <div className="w-[220px] h-[440px] md:w-[260px] md:h-[520px] rounded-[2.5rem] overflow-hidden bg-white border-2 border-gray-800">
                        <Image
